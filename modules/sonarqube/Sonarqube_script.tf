...
#!/bin/bash
  ...
  #Install New relic
  curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo NEW_RELIC_API_KEY=NRJS-NRJS-db25eb997f4d4621878 NEW_RELIC_ACCOUNT_ID=3665704 NEW_RELIC_REGION=EU /usr/local/bin/newrelic install -y
